const main = async () => {
    ...
    const waveTxn1 = await waveContract.wave('hola mundo desde deployer');
    ...
    const waveTxn2 = await waveContract.connect(randomPerson).wave('hola mundo desde otra cuenta');
